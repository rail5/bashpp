...
bool bpp_program::add_class(bpp_class class_) {
...
bool bpp_program::add_object(bpp_object object) {
...
std::vector<bpp_class> bpp_program::get_classes() const {
	std::vector<bpp_class> result;
	for (auto& c : classes) {
...
std::vector<bpp_object> bpp_program::get_objects() const {
	std::vector<bpp_object> result;
	for (auto& o : objects) {
