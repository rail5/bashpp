...
class ObjectInstantiation : public Entity {
	private:
		...
		std::weak_ptr<const Object> objectToInstantiate;
	...
	public:
		...
		std::weak_ptr<const Object> getObjectToInstantiate() const { return objectToInstantiate; }
		void setObjectToInstantiate(std::weak_ptr<const Object> o) { objectToInstantiate = std::move(o); }
