...
Bash++ is a superset of Bash that adds support for object-oriented programming. Almost all Bash code is valid Bash++ code, but Bash++ adds new syntax and features to make it possible to write object-oriented code.
